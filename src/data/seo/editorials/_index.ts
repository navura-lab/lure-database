...
import { frontFlapperCurlyEditorial } from './4-front-flapper-curly';
import { awOffsetSinkerEditorial } from './aw-offset-sinker';
import { bakureeFish62Editorial } from './bakuree-fish-62';
import { bakureeSpin8Editorial } from './bakuree-spin-8';
import { blackBlastEditorial } from './black-blast';
...
import { gorgonCustomEditorial } from './gorgon-custom-125188';
import { greed3040Editorial } from './greed3040';
import { gulpIsomeGokubutoEditorial } from './gulp-saltwater-isome-gokubuto-4inch-4';
...
import { iFishFtEditorial } from './i-fish-ft';
import { ignitedTailFusionEditorial } from './ignited-tail-fusion';
import { jackhammerBabyJackEditorial } from './jackhammerbabyjack';
import { jigaroSuperSlideEditorial } from './jigaro-superslide';
import { k2rpEditorial } from './k2rp';
...
import { oneUpShad3TwoToneEditorial } from './one-up-shad-3-2tone';
...
import { plapanEditorial } from './plapan';
...
// 2026-03-19 追加分 第16弾（10件）
import { sBitEditorial } from './s-bit';
import { jrtEditorial } from './jrt';
import { pulsecodEditorial } from './pulsecod';
import { deeperRangeEditorial } from './deeper-range';
import { tgIeyasuEditorial } from './tg-ieyasu';
import { squidSeekerMetalEditorial } from './squid-seeker-metal';
import { saltWavyEditorial } from './salt-wavy';
...
// 2026-03-21 追加分 第45弾（10件）
import { stayseeEditorial } from './staysee';
import { dJigCoverEditorial } from './d-jig-cover';
import { deeprobberEditorial } from './deeprobber-2';
import { dCompactEditorial } from './trout-d-compact';
import { tobisugiDanielBladeEditorial } from './salt-tobisugi-daniel-blade';
import { nativeSignalEditorial } from './trout-native-signal';
import { metalForzeTgEditorial } from './salt-metal-forze-tg';
...
export const editorialReviews: Record<string, EditorialReview> = {
  ...
  'aw-offset-sinker': awOffsetSinkerEditorial,
  'bakuree-fish-62': bakureeFish62Editorial,
  'bakuree-spin-8': bakureeSpin8Editorial,
  'black-blast': blackBlastEditorial,
  ...
  'dex-cr55sr': dexCr55srEditorial,
  'dex-sc55f63f': dexSc55f63fEditorial,
  'dkalube': dkalubeEditorial,
  'dowzvido': dowzvidoEditorial,
  'ds0e32p': ds0e32pEditorial,
  'ebiran-bg': ebiranBgEditorial,
  'erda-zero-innovator': erdaZeroInnovatorEditorial,
  'esnal': esnalEditorial,
  'fable': fableEditorial,
  'fallstick4': fallstick4Editorial,
  'flap-slj': flapSljEditorial,
  'flesh-back-80sp': fleshBack80spEditorial,
  'fs417': fs417Editorial,
  'fs430': fs430Editorial,
  'full-metal-sonic': fullMetalSonicEditorial,
  'furifuri-usachan-jig': furifuriUsachanJigEditorial,
  ...
  'gorgon-custom-125188': gorgonCustomEditorial,
  'greed3040': greed3040Editorial,
  'gulp-saltwater-isome-gokubuto-4inch-4': gulpIsomeGokubutoEditorial,
  ...
  'one-up-shad-3-2tone': oneUpShad3TwoToneEditorial,
  ...
  's-bit': sBitEditorial,
  'jrt': jrtEditorial,
  'pulsecod': pulsecodEditorial,
  'deeper-range': deeperRangeEditorial,
  'tg-ieyasu': tgIeyasuEditorial,
  'squid-seeker-metal': squidSeekerMetalEditorial,
  'salt-wavy': saltWavyEditorial,
  ...
  // 2026-03-21 追加分 第45弾（10件）
  'staysee': stayseeEditorial,
  'd-jig-cover': dJigCoverEditorial,
  'deeprobber-2': deeprobberEditorial,
  'trout-d-compact': dCompactEditorial,
  'salt-tobisugi-daniel-blade': tobisugiDanielBladeEditorial,
  'trout-native-signal': nativeSignalEditorial,
  'salt-metal-forze-tg': metalForzeTgEditorial,
